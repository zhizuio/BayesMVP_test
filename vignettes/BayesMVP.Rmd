...
Install the latest released version from [CRAN](https://CRAN.R-project.org/package=BayesMVP)

```r
install.packages("BayesMVP")
```
...
remotes::install_github("mbant/BayesMVP/BayesMVP")
```
