#' @title predict method for class \code{BayesMVP}
#' @description
...
#' a \code{BayesMVP} class object.
#' @name predict.BayesMVP
#'
...
#'
#' @return Predicted values extracted from an object of class \code{BayesMVP}.
...
#'
#' @export
predict.BayesMVP <- function(object, newx, type = "response",
